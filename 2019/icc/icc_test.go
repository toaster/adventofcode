...
func TestICC_ParseAndLoadAndRun(t *testing.T) {
...
func TestICC_ComputeOptimalThrusterConfig(t *testing.T) {
	...
	for name, tt := range tests {
		t.Run(name, func(t *testing.T) {
			s, p := ComputeOptimalThrusterConfig(tt.program)
...
func TestICC_ComputeOptimalLoopedThrusterConfig(t *testing.T) {
	...
	for name, tt := range tests {
		t.Run(name, func(t *testing.T) {
			s, p := ComputeOptimalLoopedThrusterConfig(tt.program)
			assert.Equal(t, tt.wantSignal, s)
			assert.Equal(t, tt.wantPhases, p)
		})
	}
...
func TestICC_RelativeBaseParameterModeAndEnhancedMemoryAndBigInt(t *testing.T) {
	tests := map[string]struct {
		program []int
		want    []int
	}{
		"relative base param & extended memory": {
